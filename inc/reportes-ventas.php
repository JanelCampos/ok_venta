...
<div class="row">
    <div class="col-xs-6">
        <h2 class="text-center" hidden="hidden"><strong>Total:</strong> S/.<span id="mostrar_total"></span></h2>
    </div>
    <div class="col-xs-6">
        <h2 class="text-center" hidden="hidden"><strong>Utilidad:</strong> S/.<span id="mostrar_utilidad"></span></h2>
    </div>
</div>
